<!DOCTYPE html>
	...
	<head>
		<meta charset="utf-8">
		<title>Form Login Survey Covid 19</title>
		<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/style/html.css">
		<link rel="icon" type="image/png" href="<?php echo base_url('assets/img/background/xxx.jpg') ?>"/>
	</head>
	<body>
	<div class="limiter">
	...
	<?= $this->session->flashdata('message'); ?>
		<span class="login100-form-title p-b-30 animated fadeInDown" style="font-family: sans-serif;font-size: 300%;margin-top: -10%">
						<img width="40%" src="<?php echo base_url('assets/img/background/corona.jpg') ?>" alt=""><br>
						<!-- <i>Newsletter</i> -->
					</span>
		<a><b><i>FORM LOGIN</i></b></a>
